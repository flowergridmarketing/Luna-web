...
export default function ServiceJourney({ steps: rawSteps }: Props) {
  ...
  const defaultSteps = [
    { title: "Initial Assessment", description: "Explore your goals and personal needs." },
    { title: "Personalised Sessions", description: "Expert guidance for real transformation." },
    { title: "Tools & Resources", description: "Guides to keep your progress on track." },
    { title: "Progress Tracking", description: "Monitor improvements and adjust." },
  ...
  }, { scope: containerRef, dependencies: [isMounted, steps] });
