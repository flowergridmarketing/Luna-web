...
const Vision = ({ title, text, buttonText, buttonLink = "/vision" }: VisionProps) => {
  ...
  useGSAP(() => {
    ...
    // Animate conditionally based on whether button exists
    const elementsToAnimate: (HTMLElement | null)[] = [titleRef.current, textRef.current];
    if (btnRef.current) elementsToAnimate.push(btnRef.current);
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left order-2 md:order-1">
          ...
          >
            {text || "Flowergrid exists to guide individuals and organisations towards holistic wellbeing through mind, body, and spirit integration. We provide personalised programmes that foster growth, resilience, and conscious living."}
          </p>
        ...
        >
          <div className="relative w-[80%] sm:w-[70%] md:w-[90%] lg:w-full max-w-lg aspect-square md:aspect-4/5">
            ...
            <Image
              src={getImageUrl("home/H vision flower.png")}
              alt="Vision Flower"
              fill
