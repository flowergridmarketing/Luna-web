        ...
        <div className="w-full overflow-hidden">
            ...
            >
                {duplicatedTestimonials.map((item, index) => (
                    <div
                        key={`${item.id}-${index}`}
                        className="w-[350px] md:w-[350px] h-[420px] md:h-[420px] shrink-0 mx-6 p-8 bg-[#E6D7C3] rounded-3xl"
                    >
                        <p className="text-[#4E351A] text-base md:text-lg leading-relaxed font-sans mb-8">
                            "{item.quote}"
                        </p>

                        <div className="h-px w-full bg-[#BFA894] mb-10"></div>
