...
const page = () => {
  return (
    <>
      ...
      <Connect image={getImageUrl("about/person2/5.png")} title='Ready to explore our holistic wellness services?' description='Book a conversation today to find the path that supports your transformation best.' btnText='Book a Consultation' />
    </>
  )
}
